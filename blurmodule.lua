--[[
this module was made by Fractality and i do not own it
got this from devforum: https://devforum.roblox.com/t/how-to-make-ui-gaussian-blur/1238701
]]
...
local continue1 = IsNotNaN(camera:ScreenPointToRay(0,0).Origin.x)
while not continue1 do
    RunService.RenderStepped:wait()
    continue1 = IsNotNaN(camera:ScreenPointToRay(0,0).Origin.x)
end
